...
$$
\eta_{i}(t) = \beta_{0, i}+\beta_{1, i} Y_{i}(t)+\beta_{2, i} \Delta_{i, 1}(t)+\beta_{3, i} \Delta_{i, 2}(t)+\beta_{4, i} \Delta_{i, 3}(t)+\epsilon_{i}(t)
$$
...
f(\boldsymbol B \mid \boldsymbol \beta)P(\boldsymbol \beta) P(\sigma^2) P(\boldsymbol \Sigma^{-1})
$$
...
\\ & - \log(\sigma^2) - (d+1)\log(|\boldsymbol \Sigma|) - \frac{1}{2}\boldsymbol \Sigma^{-1}
\end{aligned}
$$


**(Note: This formula is kind of weird since the last term is a matrix (sorry I'm kinda of inexperienced in dealing with matrices))**
