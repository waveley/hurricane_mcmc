...
ggplot(data=raw, aes(x = longitude, y = latitude)) + 
  stat_summary_2d(data = raw, aes(x = longitude, y = latitude, z = dt$Wind.kt), fun = median, binwidth = c(1, 1), show.legend = TRUE)
library(data.table)
...
map +
  stat_summary_2d(data = raw, aes(x = longitude, y = latitude, z = raw$wind.kt), fun = median, binwidth = c(1, 1), show.legend = TRUE, alpha = 0.75) + 
