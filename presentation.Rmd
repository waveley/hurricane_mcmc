...
![]("plots/LASSO_coefficients.png")

## Refitted Linear Regression Model

![]("plots/refitted_linearmodel.png")

## Poisson Model for Dealths

![]("plots/Poisson_coefficients.png")
...
- MCMC approaches are often computationally expensive and can be inefficient since they involve thousands of rounds of sampling and updating.
